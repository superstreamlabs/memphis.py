...
class Consumer:
    ...
    def stop_consume(self):
        """
        This method stops the automatic consumption of messages.
        ...
        Example:
            ...
            async def main():
                ...
                await asyncio.sleep(10)  # Consume messages for 10 seconds
                consumer.stopConsume()  # Stop consuming messages
